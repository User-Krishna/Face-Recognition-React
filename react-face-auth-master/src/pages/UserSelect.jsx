...
const accounts = [
  ...
  { id: "88421e2c-ca7a-4332-815f-6e12824e2d05", fullName: "Sophia Smith", picture: "/temp-accounts/88421e2c-ca7a-4332-815f-6e12824e2d05/1.jpg" },
...
function UserSelect() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 relative overflow-hidden bg-gray-800">
      ...
      <h1 className="text-4xl font-extrabold text-white text-center mb-8 drop-shadow-lg relative z-10">
