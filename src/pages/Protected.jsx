        ...
        <div className="text-center mb-24">
          ...
          <div
            onClick={() => {
              ...
              window.location.href = "http://localhost:8087/MiniProject/landing2.html"; // Redirect to landing.html
            }}
          ...
          >
            <span className="text-white">Get Back to Work</span> {/* Changed button text */}
            <svg
